...
# our code
# from libraries.combat_env import sigma_graph
from libraries.combat_env.sigma_graph.envs.figure8.action_lookup import MOVE_LOOKUP, TURN_90_LOOKUP
from libraries.combat_env.sigma_graph.envs.figure8.default_setup import OBS_TOKEN
from libraries.combat_env.sigma_graph.envs.figure8.figure8_squad_rllib import Figure8SquadRLLib
import libraries.combat_env.sigma_graph.envs.figure8.default_setup as default_setup
...
def parse_arguments():
    ...
    parser.add_argument('--model', default='gat', choices=['gat', 'altr', 'hybrid'])
